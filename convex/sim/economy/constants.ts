 ...
 * Scaled ×10 alongside cargo size to preserve the same per-unit transport cost.
 */
export const BG_TRADER_SHIP_HIRE_PER_TURN = 500;
/** One-time docking fee paid when the trader's ship arrives at the destination. Scaled ×10. */
export const BG_TRADER_DOCKING_COST = 200;
/**
...
/** Maximum simultaneously en-route background traders per game (keeps load bounded). */
